...
| **macOS (Apple Silicon)** | `XM-2-WAV-arm64.dmg` | Drag to Applications. First launch: **right-click → Open** (unsigned/un-notarised). |
| **macOS (Intel)** | — | Use the pip path below (`brew install libopenmpt` then `pipx install "xm-2-wav[preview]"`). |
